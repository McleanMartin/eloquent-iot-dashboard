...
from eloquent_app.models.devices import Device
from django.contrib.auth.models import User,Group


class EloquentAdmin(admin.AdminSite):
    site_header = "Eloquent"

server = EloquentAdmin(name="Eloquent")
...
server.register(LogEntry, LogEntryAdmin)
